...
<!--Table and operation field -->
    ...
    <div class="card-body">
         ...
         <Button class="btn btn-primary" onclick="printJS({printable: 'printJS-form', type: 'html', header: 'General Order Dashbord',css:['/css/app.css','css/order_system_css/orderStylesheet.css'],ignoreElements:['noprint','nocell']
...
<!--General item order-->
    ...
    <Button class="btn btn-primary" onclick="printJS({printable: 'printContainer-2', type: 'html', header: 'Medical Order Dashbord',css:['/css/app.css','css/order_system_css/orderStylesheet.css'],ignoreElements:['noprint-m','nocell-m']
})" style="margin-left: 20px; margin-bottom: 10px;"> Generate report</Button>
