              ...
              <div class="widget big-stats-container">
                <div class="widget-content">
                  ...
                  <div id="big_stats" class="cf">
                    ...
                    <div class="stat"><h6>Centers</h6> <span class="value">{{ Center::count() }}</span> </div>
			 ...
			 <div class="widget-content">
              <div class="shortcuts"> 
                <a href="/home_prescription" class="shortcut"><img src="{{ asset('img/newspaper.png') }}"><span class="shortcut-label">Prescriptions</span>
                  ...
                  <img src="{{ asset('img/newspaper.png') }}"><span class="shortcut-label">Vaccination Records</span</a>
                ...
                <a href="/center" class="shortcut"><img src="{{ asset('img/newspaper.png') }}"><span class="shortcut-label">Center Details</span>
							</div>
